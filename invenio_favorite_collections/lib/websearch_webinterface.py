...
#                    format = path[1]
    ...
    # CDS Hack begins
    def search_q_viz(self, req, form):
        """ Open separate page for visualizations """

        #argd = wash_urlargd(form, websearch_templates.tmpl_openurl_accepted_args)
        return websearch_templates.tmpl_search_query_viz()
...
def display_collection(req, c, aas, verbose, ln, em=""):
    ...
    c_body, c_navtrail, c_portalbox_lt, c_portalbox_rt, c_portalbox_tp, c_portalbox_te, \
        c_last_updated = perform_display_collection(uid, colID, c, aas, ln, em,
